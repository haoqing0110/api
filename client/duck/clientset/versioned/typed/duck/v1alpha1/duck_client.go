...
import (
	...
	"open-cluster-management.io/api/client/duck/clientset/versioned/scheme"
	v1alpha1 "open-cluster-management.io/api/duck/v1alpha1"
)

type DuckV1alpha1Interface interface {
	RESTClient() rest.Interface
	UpgradableTypesGetter
}

// DuckV1alpha1Client is used to interact with features provided by the duck.open-cluster-management.io group.
...
// NewForConfigAndClient creates a new DuckV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DuckV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
